...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi whereTransaksiId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi whereProdukId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi whereHarga($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi whereQty($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi whereSubtotal($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi query()
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<DetailTransaksi>|DetailTransaksi timeout(int $seconds)
     ...
     */
    class DetailTransaksi extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\DetailTransaksi> $detailTransaksis
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Produk>|Produk timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Transaksi>|Transaksi whereKodeTransaksi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Transaksi>|Transaksi whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Transaksi>|Transaksi whereTotal($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Transaksi>|Transaksi whereBayar($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Transaksi>|Transaksi whereKembalian($value)
